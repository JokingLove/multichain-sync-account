...
import (
	...
	"github.com/JokingLove/multichain-sync-account/common/bigint"
)

var (
	ErrBatchBlockAheadOfProvider = errors.New("the BatchBlock's internal state is  ahead of provider")
)
